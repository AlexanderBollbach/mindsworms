...
func flowLayoutImpl<Id>(
    ...
    spacing: UIOffset = UIOffset(horizontal: 30, vertical: 30),
    sizes: [(Id, CGSize)],
...
func flowLayout<Elements>(alignment: FlowAlignment = .justify) ->
    (_ elements: Elements, _ containerSize: CGSize, _ sizes: [(Elements.Element.ID, CGSize)]) ->
    [Line<Elements.Element.ID>] where Elements: RandomAccessCollection, Elements.Element: Identifiable {
...
struct CollectionView<Elements, Content>: View where Elements: RandomAccessCollection, Content: View, Elements.Element: Identifiable {
    ...
    init(
        data: Elements,
        layout: @escaping Layout = flowLayout(alignment: .leading),
        onReorder: Reorder? = nil,
